...
#import "LKTransferDataHelper.h"

@implementation LKTransferDataConfig
...
+ (instancetype)configMTUSize:(NSUInteger)mtuSize packetHeadSize:(NSUInteger)packetHeadSize byteSortType:(JKTransferByteSortType)byteSortType{
    LKTransferDataConfig *dataConfig = [[LKTransferDataConfig alloc] init];
...
@implementation LKTransferDataHelper
...
+ (NSMutableData *)configPacketBody:(NSData *)data dataConfig:(LKTransferDataConfig *)dataConfig{
...
+ (NSMutableData *)getDataWithNoSortNum:(NSData *)data dataConfig:(LKTransferDataConfig *)dataConfig{
...
+ (NSUInteger)getPacketHeadSizeWithOriginData:(NSData *)originData mtuSize:(NSUInteger)mtuSize{
    ...
    LKTransferDataConfig *dataConfig = [LKTransferDataConfig new];
    dataConfig.mtuSize = mtuSize;
